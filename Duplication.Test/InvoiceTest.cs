...
public class InvoiceTests
{
    ...
    public void CalculateTotal_AllItemsPresent_ReturnsCorrectTotal()
    {
        ...
        var invoice = new Invoice(item1, item2, item3, item4, item5, new Item[] { });
    ...
    {
        var invoice = new Invoice(null, null, null, null, null, new Item[] { });
    ...
    public void CalculateTotal_SingleItemOnly_ReturnsSingleSubtotal()
    {
        ...
        var invoice = new Invoice(item1, null, null, null, null, new Item[] { });
    ...
    public void CalculateTotal_ZeroQuantityItems_ReturnsZeroForThoseItems()
    {
        ...
        var invoice = new Invoice(item1, item2, null, null, null, new Item[] { });
